...
<div class=" hidden lg:block">
    <ul class="flex space-x-10 tracking ">
        ...
        <li  class="cursor-pointer" > 
            <a href="https://www.sigmafactory.fun/" target="_blank">
            <Icon icon="fluent:emoji-meme-16-filled" class="inline-block mr-1 text-accentPrimary" width="20" /> <span class="hover:text-accentPrimary transition-all duration-300">MEME FACTORY</span>
        </a></li>
